...
const bannerTxt = `/*! vue-sky v${pack.version} | MIT License | https://github.com/andrewjm118/vue-sky*/`
...
export default () => {
  ...
  let config = [
    ...
    },
    {
      ...
      output: {
        format: 'umd',
        name: capitalize('vue-sky'),
        file: 'dist/vue-sky.js',
        exports: 'named',
        banner: bannerTxt,
        globals: {
          vue: 'Vue'
