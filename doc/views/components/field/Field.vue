<template>
  <div>
    ...
    <Example
      :component="ExLabelPosition"
      :code="ExLabelPositionCode"
    ...
    <Example
      :component="ExGroupExpanded"
      :code="ExGroupExpandedCode"
      title="Nested groups"
    >
      <p>
    ...
    <Example
      :component="ExGroupMultiline"
      :code="ExGroupMultilineCode"
      title="Responsive groups"
      vertical
    >
      <p>
    ...
    <Example
      :component="ExCombineAddonsGroups"
      :code="ExCombineAddonsGroupsCode"
      title="Combining addons and groups"
    />

    <Example
      :component="ExHorizontal"
      :code="ExHorizontalCode"
      title="Horizontal"
    >
    ...
    <Example
      :component="ExCustomClass"
      :code="ExCustomClassCode"
      title="Label classes"
    >
    ...
    <Example
      :component="ExLabelSlot"
      :code="ExLabelSlotCode"
      title="Label slot"
    >
      <div class="tags has-addons">
        <span class="tag is-success">New!</span>
