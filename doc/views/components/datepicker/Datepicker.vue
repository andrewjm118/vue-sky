<template>
  <div>
    ...
    <Example
      :component="ExEditable"
      :code="ExEditableCode"
      title="Editable (non readonly)"
      vertical
    >
      ...
      >
        ...
        <a
          href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date/parse"
          target="_blank"
        >Date.parse()</a>
        and it only works for <b>mm-dd-yyyy</b> format. If your locale is different, you have to pass a custom one with
        <code>date-parser</code> prop, or by setting a <router-link to="/documentation/constructor-options">
          constructor option
        </router-link>.
      </s-message>
    </Example>
    ...
    <Example
      :component="ExRangeInput"
      :code="ExRangeInputCode"
