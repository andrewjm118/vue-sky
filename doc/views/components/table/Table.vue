<template>
  <div>
    <Example
      ...
      :code="ExSimpleCode"
    >
      <p>要显示数据表非常简单, 只需要一个<code>data</code> and  <code>columns</code> prop.</p>
    </Example>
    ...
    >
      <p>
        您可以通过将相应的对象传递给<code>selected</code>来显示单个选中的行。
      </p>
      <p>此外，添加.sync修饰符将使其双向绑定—如果用户单击row，所选对象将发生变化。</p>
    </Example>
