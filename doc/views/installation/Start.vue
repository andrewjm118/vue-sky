    ...
    <div class="media">
      ...
      <div class="media-content">
        ...
        <b-message type="is-info">
          To include individual styles, see <router-link to="/documentation/customization">
            Customization
          </router-link> section.
        </b-message>
      </div>
...
export default {
  data () {
    return {
      ...
      importingCDNHtml: 'importingCDNHtml demo',
